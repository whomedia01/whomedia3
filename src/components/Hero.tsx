...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="hero" className="relative flex items-center justify-center pt-20 pb-12 sm:pt-24 sm:pb-16 overflow-hidden bg-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          {/* Top Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/90 border border-red-500/30 shadow-inner backdrop-blur-md text-xs sm:text-sm font-semibold text-slate-200">
          ...
          <div className="space-y-3">
            ...
            <p className="text-base sm:text-lg text-slate-300 font-normal leading-relaxed max-w-xl mx-auto">
              고품격 4K 스튜디오 · 전자칠판 · 크로마키 · AI 미디어 제작 솔루션
            </p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-1">
            <a
              href="#portfolio"
              className="px-7 py-3.5 rounded-xl text-sm sm:text-base font-bold text-white bg-gradient-to-r from-red-600 via-rose-600 to-red-700 hover:from-red-500 hover:to-rose-500 shadow-xl shadow-red-600/30 hover:shadow-red-600/50 transition-all flex items-center gap-2 group active:scale-95"
            >
            ...
            <a
              href="#studio"
              className="px-7 py-3.5 rounded-xl text-sm sm:text-base font-bold text-slate-200 bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 hover:border-slate-500 transition-all flex items-center gap-2 backdrop-blur-md active:scale-95"
            >
          ...
          <div className="pt-6 grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-5 border-t border-slate-800/80 text-left">
